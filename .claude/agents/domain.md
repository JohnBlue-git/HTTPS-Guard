...
Scope note: "repo root" below means `meta-https-guard/`, not the outer OpenBMC multi-layer checkout it happens to live inside. That checkout's git root is unrelated to this project's domain model.
