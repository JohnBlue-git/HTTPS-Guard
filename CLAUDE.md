...
- All 20 tracked tickets are closed; `.scratch/extend-detection-coverage/PRIORITY.md` is the ledger, including the three "done with caveats" entries worth knowing before trusting them (see `.claude/agents/issue-tracker.md`).
